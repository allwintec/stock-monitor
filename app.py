...
support = support.item() if isinstance(support, pd.Series) else support  # 如果是 Series 轉為數值
resistance = resistance.item() if isinstance(resistance, pd.Series) else resistance  # 同上
